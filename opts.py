...
def parse_args():
    ...
    parser.add_argument('--node_num', type=int, default=24)
    ...
    parser.add_argument('--drop_out', type=float, default= 0.2, help="dopr in net")
    ...
    #################### 使用这里的参数去更改训练方式 #######################
    parser.add_argument('--train_model', type=str, default="mgda", help="swl, mgda, mgda3")
    ...
    parser.add_argument('--dir_b', type=float, default= 0.9)
    ...
    parser.add_argument('--n', type=float, default=0.001)
